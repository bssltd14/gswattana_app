...
class UploadSlipIntReducePage extends StatefulWidget {
  UploadSlipIntReducePage();

  @override
  _UploadSlipIntReducePageState createState() =>
      _UploadSlipIntReducePageState();
}
...
class _UploadSlipIntReducePageState extends State<UploadSlipIntReducePage> {
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            image: DecorationImage(
                                image:
                                    AssetImage("assets/images/promptpay.png"))),
                      ),
                      SizedBox(width: 10),
                      Column(
                        ...
                        if (snapshot.data == true) {
                          return Column(
                            children: [
                              ...
                              SizedBox(height: 10),
                              Text(
                                "ดอกเบี้ยที่ต้องชำระ ${Constant.formatNumber2.format(Constant.IntCal)} บาท",
                                style: TextStyle(
                                  fontSize: 20,
                                  color: Constant.FONT_COLOR_MENU,
                                ),
                    ...
                    child: Container(
                      ...
                      child: TextButton(
                        ...
                        onPressed: () async {
                          ...
                          if (_imageFile != null) {
                            if (_AmountPayCal >= double.parse(Constant.Amountget.toString().replaceAll(",", ""))) {
                              showDialogBeforeDueDate(context);
                            } else {
                                  ...
                                  await _storage
                                    ...
                                    try {
                                      ...
                                      var requestBody = jsonEncode({
                                        ...
                                        "timeTran":
                                            "${Constant.SelectTime.hour.toString().padLeft(2, '0')}:${Constant.SelectTime.minute.toString().padLeft(2, '0')}",
                              ...
                              if (statusCode == 204) {
                                ...
                                final responseSendnoti = await http.put(
                                    Uri.parse(
                                        "${Constant.API}/AddMobileAppNotiSent?BranchName=${Constant.MobileAppPaymentIntBranchName}&NotiTitle=ลดเงินต้น&NotiRefNo=${Constant.MobileAppPaymentIntBillId}&NotiDetail=รออนุมัติ ลดเงินต้น ${Constant.formatNumber
                                  .format(_AmountPayCal)} บาท ดอกเบี้ย ${Constant.formatNumber.format(Constant.IntCal)} บาท&CustTel=${Constant.CUSTTEL}"),
