...
List<SavingResponse> savingResponseFromJson(String str) => List<SavingResponse>.from(json.decode(str).map((x) => SavingResponse.fromJson(x)));

String savingResponseToJson(List<SavingResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class SavingResponse {
  ...
  factory SavingResponse.fromJson(Map<String, dynamic> json) => SavingResponse(
    ...
    autoNo: json["autoNo"],
      prTime: json["prTime"],
      moneyBackWard: json["moneyBackWard"],
  );
